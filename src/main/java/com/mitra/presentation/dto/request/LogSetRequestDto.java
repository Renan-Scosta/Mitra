...
public record LogSetRequestDto(
        @NotNull(message = "Exercise ID is required") @Schema(description = "ID of the exercise", example = "5")
                Long exerciseId,
        @Schema(description = "Weight lifted in kg (if applicable)", example = "45.0")
                BigDecimal weightKg,
        @Schema(description = "Number of repetitions performed", example = "12") Integer reps,

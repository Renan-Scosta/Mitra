...
class ExerciseControllerTest {
    ...
    @MockitoBean private GetAllExercisesUseCase getAllExercisesUseCase;

    @MockitoBean private GetExerciseHistoryUseCase getExerciseHistoryUseCase;

    @MockitoBean private GetPersonalRecordsUseCase getPersonalRecordsUseCase;
    ...
    void shouldReturnAllExercises() throws Exception {
        when(getAllExercisesUseCase.execute(any()))
                .thenReturn(
                        new PageImpl<>(
                                List.of(
    ...
    void shouldReturnExerciseHistory() throws Exception {
        ...
        ExerciseHistoryResponseDto.SetHistoryDto setDto =
                new ExerciseHistoryResponseDto.SetHistoryDto(new BigDecimal("100"), 10, null);
        ExerciseHistoryResponseDto.SessionHistoryDto sessionDto =
                new ExerciseHistoryResponseDto.SessionHistoryDto(
                        100L, java.time.LocalDateTime.now(), List.of(setDto));
        ExerciseHistoryResponseDto responseDto =
                new ExerciseHistoryResponseDto(5L, "Bench", List.of(sessionDto));
    ...
    void shouldReturnPersonalRecords() throws Exception {
        ...
        PersonalRecordResponseDto responseDto =
                new PersonalRecordResponseDto(
                        5L, "Bench", new BigDecimal("120.0"), 12, new BigDecimal("1080"), null, 3);

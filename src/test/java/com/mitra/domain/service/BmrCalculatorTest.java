 ...
 *
 * <p>No Spring context is loaded — this is a pure domain test.
 */
class BmrCalculatorTest {
    ...
    void calculate_maleUser_returnsCorrectBmr() {
        ...
        assertEquals(1718.75, bmr, 0.01, "BMR should match Mifflin-St Jeor formula for male");
    }
    ...
    void calculate_femaleUser_appliesFemaleConstant() {
        ...
        assertEquals(1357.75, bmr, 0.01, "BMR should apply -161 constant for female");
    }

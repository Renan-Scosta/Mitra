...
class RegisterUserUseCaseImplTest {
    ...
    void setUp() {
        useCase =
                new RegisterUserUseCaseImpl(
                        userRepositoryPort, bodyMeasurementRepositoryPort, passwordEncoderPort);
    }
    ...
    void shouldThrowWhenEmailAlreadyRegistered() {
        ...
        when(userRepositoryPort.findByEmail("existing@mitra.com"))
                .thenReturn(
                        Optional.of(User.builder().id(99L).email("existing@mitra.com").build()));

...
class GetUserDashboardUseCaseImplTest {
    ...
    @Mock private CalculateSessionCaloriesUseCase calculateSessionCaloriesUseCase;
    ...
    void setUp() {
        useCase =
                new GetUserDashboardUseCaseImpl(
                        sessionRepositoryPort, calculateSessionCaloriesUseCase);
    }

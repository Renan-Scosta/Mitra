...
public record AddRoutineExerciseRequestDto(
        @NotNull(message = "Exercise ID is required") @Schema(description = "ID of the exercise to add", example = "5")
                Long exerciseId,
        @NotNull(message = "Target sets is required") @Min(value = 1, message = "Target sets must be at least 1")

...
public record ExerciseResponseDto(
        @Schema(description = "Unique identifier of the exercise", example = "1") Long id,
        @Schema(description = "Name of the exercise", example = "Bench Press") String name,
        @Schema(description = "Target muscle group", example = "Chest") String muscleGroup,

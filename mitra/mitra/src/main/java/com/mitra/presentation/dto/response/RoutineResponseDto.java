...
public record RoutineResponseDto(
        @Schema(description = "Unique identifier of the routine", example = "10") Long id,
        @Schema(description = "ID of the user who owns the routine", example = "1") Long userId,
        @Schema(description = "Name of the routine", example = "Full Body Workout A") String name,

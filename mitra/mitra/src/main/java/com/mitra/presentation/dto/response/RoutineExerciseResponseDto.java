...
public record RoutineExerciseResponseDto(
        @Schema(
                        description = "Unique identifier of this routine exercise assignment",
                        example = "25")
                Long id,
        @Schema(description = "Exercise details") ExerciseResponseDto exercise,
        @Schema(description = "Target number of sets", example = "4") Integer targetSets,

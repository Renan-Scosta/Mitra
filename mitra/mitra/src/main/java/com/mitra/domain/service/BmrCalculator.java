...
/**
 * Domain service that calculates the Basal Metabolic Rate (BMR) using the Mifflin-St Jeor equation.
 *
 * <p>Formula:
 *
 * <ul>
 *   <li>Male: BMR = (10 × weight_kg) + (6.25 × height_cm) - (5 × age) + 5
 *   <li>Female: BMR = (10 × weight_kg) + (6.25 × height_cm) - (5 × age) - 161
 * </ul>
 *
...
public class BmrCalculator {
    ...
    public double calculate(User user, BigDecimal weightKg) {
        ...
        double base =
                (WEIGHT_FACTOR * weightKg.doubleValue())

...
class UserControllerTest {
    ...
    @MockitoBean private CalculateBmrUseCase calculateBmrUseCase;

    @MockitoBean private com.mitra.application.usecase.RegisterUserUseCase registerUserUseCase;
    ...
    void shouldReturn404WhenUserOrMeasurementNotFound() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/users/me/bmr")).andExpect(status().isNotFound());
    }
    ...
    void shouldUpdateProfileAndReturn200() throws Exception {
        ...
        when(updateUserProfileUseCase.execute(any(), any()))
                .thenReturn(
                        new com.mitra.presentation.dto.response.UserProfileResponseDto(
                                ...
                                com.mitra.domain.model.enums.Gender.MALE,
                                185,
                                26));

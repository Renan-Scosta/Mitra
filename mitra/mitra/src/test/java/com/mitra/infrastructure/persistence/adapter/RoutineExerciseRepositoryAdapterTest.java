...
class RoutineExerciseRepositoryAdapterTest extends AbstractIntegrationTest {
    ...
    @Autowired private RoutineExerciseJpaRepository routineExerciseJpaRepository;
    ...
    void setUp() {
        adapter =
                new RoutineExerciseRepositoryAdapter(
                        routineExerciseJpaRepository, routineJpaRepository, exerciseJpaRepository);

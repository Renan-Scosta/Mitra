...
class GetUserSessionsUseCaseImplTest {
    ...
    void shouldReturnAllSessionsForUser() {
        ...
        when(workoutSessionRepositoryPort.findByUserIdAndDateRange(
                        eq(1L),
        ...
        Page<WorkoutSessionResponseDto> result =
                useCase.execute(1L, null, null, PageRequest.of(0, 10));
    ...
    void shouldReturnEmptyListWhenNoSessions() {
        ...
        Page<WorkoutSessionResponseDto> result =
                useCase.execute(99L, LocalDate.now(), LocalDate.now(), PageRequest.of(0, 10));
